...
static const DTDNotificationOptions DTDNotificationOptionNone =  0;
...
/**
 * @brief Push Notification options this app will request from APNS. Defaults to Alert, Sound and Badge.
 */
@property (nonatomic, assign) DTDNotificationOptions pushNotificationsOptions;
